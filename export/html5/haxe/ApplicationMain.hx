...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("haxerpg01", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("haxerpg01", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "2";
		app.meta["company"] = "Lemur";
		app.meta["file"] = "haxerpg01";
		app.meta["name"] = "haxerpg01";
